...
public class UserInfo {
    ...
    public Integer getIsGarder() {
        return isGarder;
    }

    public void setIsGarder(Integer isGarder) {
        this.isGarder = isGarder;
    }
    ...
    public String getYumiaoAccount() {
        return yumiaoAccount;
    }

    public void setYumiaoAccount(String yumiaoAccount) {
        this.yumiaoAccount = yumiaoAccount;
    }
    ...
    public void setUseraddrss(String useraddrss) {
        this.useraddrss = useraddrss == null ? null : useraddrss.trim();
    }
    ...
    public void setWechatopenid(String wechatopenid) {this.wechatopenid = wechatopenid == null ? null : wechatopenid.trim();}
