...
public class CollectionServiceImpl implements CollectionService {
    ...
    @Override
    public List<Map<String,Object>> selectByNoteid(List<String> list,String year) {
        return collectionMapper.selectByNoteid(list,year);
    }

    @Override
    public List<Map<String,Object>> selectYearByNoteid(List<String> list) {
    ...
    @Override
    public  List<Map<String,Object>> countsFromControllor(String Noteid,String year) {
        return collectionMapper.countsFromControllor(Noteid,year);
    }
}
